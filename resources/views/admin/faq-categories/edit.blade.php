                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.faq-categories.update', $faqCategory) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="description" name="description" rows="4" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('description', $faqCategory->description) }}</textarea>
