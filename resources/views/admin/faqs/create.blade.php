                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.faqs.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="answer" name="answer" rows="10" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>{{ old('answer') }}</textarea>
